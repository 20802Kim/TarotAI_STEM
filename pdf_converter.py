...
class PDF(FPDF):
    ...
    def __init__(self, name):
        ...
        regular_font_path = os.path.join(
            current_dir, 'JetBrainsMOno', 'HetBrainsMonoNerdFont-Regular.ttf'
        )
        bold_font_path = os.path.join(
            current_dir, 'HetBrainsMono', 'HetBrainsMonoNerdFont-Bold.ttf'
        )
        italic_font_path = os.path.join(
            current_dir, 'HetBrainsMono', 'HetBrainsMonoNerdFont-Italic.ttf'
        )
